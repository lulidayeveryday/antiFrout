    ...
    children: [
      {
        ...
        component: () => import('@/views/fraud-management/report-involved'),
        name: '涉案号码举报',
        meta: { title: '涉案号码举报', icon: 'clipboard'}
      },
      {
        path: 'hawk-eye-detection',
        component: () => import('@/views/fraud-management/hawk-eye-detection'),
        name: '鹰眼检出诈骗号码',
        meta: { title: '鹰眼检出诈骗号码', icon: 'link' }
      },
      {
        path: 'high-risk-roaming',
        component: () => import('@/views/fraud-management/high-risk-roaming'),
        name: '高危漫游话务异常筛选',
        meta: { title: '高危漫游话务异常', icon: 'example' }
      },
      {
        path: 'sales-increase',
        component: () => import('@/views/fraud-management/sales-increase'),
        name: '销量突增预警',
        meta: { title: '销量突增', icon: 'form' }
      },
    ]
  },*/
  /*{
